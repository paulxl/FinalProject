...
INSERT INTO `trip` (`id`, `companies_id`, `vehicle_id`, `launchport_id`, `title`, `destination`, `cost`, `length_trip`, `trip_date`, `photo_url`) VALUES (7, 7, 7, 2, 'Balloning in Venus Gases', 'Venus Cloud City', 90000, 1400, NULL, 'assets/img/venusCloudColony.png');
